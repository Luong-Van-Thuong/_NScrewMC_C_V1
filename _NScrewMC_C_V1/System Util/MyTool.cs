            ...
            TextFormatFlags flags, GroupBoxState state)
        {
            ...
            using (var pen = new Pen(this.BorderColor))
            {
                ...
                g.DrawLine(pen, bounds.Left, bounds.Height - 2, bounds.Width - 1,
                    bounds.Height - 2);
                g.DrawLine(pen, bounds.Left, num - 1, rectangle.X - 2, num - 1);
                g.DrawLine(pen, rectangle.X + rectangle.Width-1, num - 1,
                    bounds.Width - 2, num - 1);
                g.DrawLine(pen, bounds.Width -1, num -1 , bounds.Width-1,
                   bounds.Height-2);
            }
        }
    }
