...
namespace _NScrewMC_C_V1
{
    public class Rect_Obj
    {
        ...
        public Point _Center1 = new Point(0, 0);
        public Point _Center2 = new Point(0, 0);
        public Point _Center3 = new Point(0, 0);
        public Point _Center4 = new Point(0, 0);
        public Point _Center5 = new Point(0, 0);
        public int _Radius=1;
        public int _Radius1 = 1;
        public int _Radius2 = 1;
        public int _Radius3 = 1;
        public int _Radius4 = 1;
        public int _Radius5 = 1;
        ...
        public void DrawCircle(Point _PCenter, int _Rad,int _index)
        {
            if (_index == 0)
            {
                _Center = _PCenter;
        ...
        // Zoom In, Zoom Out, btnTestRegionSave 시에 사용
        public Rect_Obj(PictureBox pc, int X, int Y, int Width, int Height, string text, bool isSizable, Color color)
        {
            Rect_Text = text;
        ...
        private void Draw(Graphics g)
        {
            ...
            g.DrawEllipse(_Pen, _Center.X- _Radius/2, _Center.Y- _Radius / 2, _Radius, _Radius);
            _Pen = new Pen(Color.LimeGreen, 2);
            g.DrawEllipse(_Pen, _Center1.X - _Radius1 / 2, _Center1.Y - _Radius1 / 2, _Radius1, _Radius1);
            g.DrawEllipse(_Pen, _Center2.X - _Radius2 / 2, _Center2.Y - _Radius2 / 2, _Radius2, _Radius2);
            g.DrawEllipse(_Pen, _Center3.X - _Radius3 / 2, _Center3.Y - _Radius3 / 2, _Radius3, _Radius3);
            g.DrawEllipse(_Pen, _Center4.X - _Radius4 / 2, _Center4.Y - _Radius4 / 2, _Radius4, _Radius4);
            g.DrawEllipse(_Pen, _Center5.X - _Radius5 / 2, _Center5.Y - _Radius5 / 2, _Radius5, _Radius5);
        }
        ...
        private void mPictureBox_Paint(object sender, PaintEventArgs e)
        {
            ...
            {
                // Log.AddLog("mPictureBox_Paint() in Rect_Obj exception " + ex.ToString());
